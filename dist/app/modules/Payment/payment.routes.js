...
router.get('/:id', (0, auth_1.auth)(client_1.UserRole.ADMIN, client_1.UserRole.USER), payment_controller_1.paymentController.getAllPaymentByUser);
router.get('/sell-info', (0, auth_1.auth)(client_1.UserRole.ADMIN), payment_controller_1.paymentController.sellInfo);
